...
const SERVICE_ITEMS = [
  {
    ...
    description: "Worldwide routes and UK domestic connections, matched to your dates and budget.",
    icon: Plane,
  },
  {
    label: "Holiday packages",
    description: "Curated package holidays with flights, stays, and transfers in one enquiry.",
    icon: Palmtree,
  },
  {
    label: "City breaks",
    description: "Short urban escapes to Europe and beyond — culture, dining, and weekend getaways.",
    icon: Building2,
  },
  {
    label: "Family holidays",
    description: "Trips designed around families, with flexible dates and room configurations.",
    icon: Users,
  },
  {
    label: "Beach holidays",
    description: "Sun-soaked destinations for couples, families, and groups seeking a coastal break.",
    icon: Globe2,
  },
  {
    label: "Last-minute travel deals",
    description: "Urgent getaways and spontaneous trips when time is tight but wanderlust wins.",
    icon: Clock3,
  },
  {
    label: "Multi-city itineraries",
    description: "Complex routes across multiple destinations, planned with care by our specialists.",
    icon: MapPinned,
  },
  {
    label: "Group travel enquiries",
    description: "Coordinated travel for groups — events, celebrations, and shared adventures.",
    icon: UsersRound,
  },
] as const;
